...
- Updated dependency [`@graphql-mesh/plugin-rate-limit@^0.105.0` ↗︎](https://www.npmjs.com/package/@graphql-mesh/plugin-rate-limit/v/0.105.0) (from `^0.104.12`, in `dependencies`)
