...
Stability: [stable](https://www.mediawiki.org/wiki/API_versioning#Stable). **/
  ...
  media_math_formula_by_hash: InContextSdkMethod<Query['media_math_formula_by_hash'], Querymedia_math_formula_by_hashArgs, {}>,
  /** Given a request hash, renders a TeX formula into its mathematic
representation in the given format. When a request is issued to the
`/media/math/check/{format}` POST endpoint, the response contains the
`x-resource-location` header denoting the hash ID of the POST data. Once
...
Stability: [stable](https://www.mediawiki.org/wiki/API_versioning#Stable). **/
  ...
  media_math_render_by_format_by_hash: InContextSdkMethod<Query['media_math_render_by_format_by_hash'], Querymedia_math_render_by_format_by_hashArgs, {}>,
  /** Given a Mediawiki project and a date range, returns a timeseries of absolute bytes
difference sums. You can filter by editors-type (all-editor-types, anonymous, group-bot,
name-bot, user) and page-type (all-page-types, content, non-content). You can choose
between daily and monthly granularity as well.
...
- License: Data accessible via this endpoint is available under the
  ...
  metrics_bytes_difference_net_aggregate_by_project_by_editor_type_by_page_type_by_granularity_by_start_by_end: InContextSdkMethod<Query['metrics_bytes_difference_net_aggregate_by_project_by_editor_type_by_page_type_by_granularity_by_start_by_end'], Querymetrics_bytes_difference_net_aggregate_by_project_by_editor_type_by_page_type_by_granularity_by_start_by_endArgs, {}>,
  /** Given a Mediawiki project, a page-title prefixed with canonical namespace (for
instance 'User:Jimbo_Wales') and a date range, returns a timeseries of bytes
difference net sums. You can filter by editors-type (all-editor-types, anonymous,
group-bot, name-bot, user). You can choose between daily and monthly granularity as well.
...
- License: Data accessible via this endpoint is available under the
  ...
  metrics_pageviews_aggregate_by_project_by_access_by_agent_by_granularity_by_start_by_end: InContextSdkMethod<Query['metrics_pageviews_aggregate_by_project_by_access_by_agent_by_granularity_by_start_by_end'], Querymetrics_pageviews_aggregate_by_project_by_access_by_agent_by_granularity_by_start_by_endArgs, {}>,
  /** Given a Mediawiki article and a date range, returns a daily timeseries of its pageview
counts. You can also filter by access method and/or agent type.
...
- License: Data accessible via this endpoint is available under the
  ...
  metrics_pageviews_top_by_country_by_project_by_access_by_year_by_month: InContextSdkMethod<Query['metrics_pageviews_top_by_country_by_project_by_access_by_year_by_month'], Querymetrics_pageviews_top_by_country_by_project_by_access_by_year_by_monthArgs, {}>,
  /** Lists the 1000 most viewed articles for a given project and timespan (month or day).
You can filter by access method.
...
- License: Data accessible via this endpoint is available under the
  ...
  metrics_pageviews_top_by_project_by_access_by_year_by_month_by_day: InContextSdkMethod<Query['metrics_pageviews_top_by_project_by_access_by_year_by_month_by_day'], Querymetrics_pageviews_top_by_project_by_access_by_year_by_month_by_dayArgs, {}>,
  /** Given a Mediawiki project and a date range, returns a timeseries of its newly registered
users counts. You can choose between daily and monthly granularity. The newly registered
users value is computed with self-created users only, not auto-login created ones.
...
- License: Data accessible via this endpoint is available under the
  ...
  metrics_registered_users_new_by_project_by_granularity_by_start_by_end: InContextSdkMethod<Query['metrics_registered_users_new_by_project_by_granularity_by_start_by_end'], Querymetrics_registered_users_new_by_project_by_granularity_by_start_by_endArgs, {}>,
  /** Given a project and a date range, returns a timeseries of unique devices counts.
You need to specify a project, and can filter by accessed site (mobile or desktop).
You can choose between daily and hourly granularity as well.
...
- License: Data accessible via this endpoint is available under the
  ...
  metrics_unique_devices_by_project_by_access_site_by_granularity_by_start_by_end: InContextSdkMethod<Query['metrics_unique_devices_by_project_by_access_site_by_granularity_by_start_by_end'], Querymetrics_unique_devices_by_project_by_access_site_by_granularity_by_start_by_endArgs, {}>,
  /** Fetches the list of language pairs the back-end service can translate
...
Stability: [unstable](https://www.mediawiki.org/wiki/API_versioning#Unstable) **/
  ...
  transform_list_pair_by_from_by_to: InContextSdkMethod<Query['transform_list_pair_by_from_by_to'], Querytransform_list_pair_by_from_by_toArgs, {}>,
  /** Fetches the list of tools and all of the language pairs it can translate

Stability: [unstable](https://www.mediawiki.org/wiki/API_versioning#Unstable) **/

  transform_list_tool_by_tool: InContextSdkMethod<Query['transform_list_tool_by_tool'], Querytransform_list_tool_by_toolArgs, {}>,
  /** Fetches the list of tools and all of the language pairs it can translate

Stability: [unstable](https://www.mediawiki.org/wiki/API_versioning#Unstable) **/

  transform_list_tool_by_tool_by_from: InContextSdkMethod<Query['transform_list_tool_by_tool_by_from'], Querytransform_list_tool_by_tool_by_fromArgs, {}>,
  /** Fetches the list of tools and all of the language pairs it can translate

Stability: [unstable](https://www.mediawiki.org/wiki/API_versioning#Unstable) **/

  transform_list_tool_by_tool_by_from_by_to: InContextSdkMethod<Query['transform_list_tool_by_tool_by_from_by_to'], Querytransform_list_tool_by_tool_by_from_by_toArgs, {}>,
  /** Fetches the dictionary meaning of a word from a language and displays
it in the target language.

Stability: [unstable](https://www.mediawiki.org/wiki/API_versioning#Unstable) **/

  transform_word_from_by_from_lang_to_by_to_lang_by_word: InContextSdkMethod<Query['transform_word_from_by_from_lang_to_by_to_lang_by_word'], Querytransform_word_from_by_from_lang_to_by_to_lang_by_wordArgs, {}>,
  /** Fetches the dictionary meaning of a word from a language and displays
it in the target language.

Stability: [unstable](https://www.mediawiki.org/wiki/API_versioning#Unstable) **/

  transform_word_from_by_from_lang_to_by_to_lang_by_word_by_provider: InContextSdkMethod<Query['transform_word_from_by_from_lang_to_by_to_lang_by_word_by_provider'], Querytransform_word_from_by_from_lang_to_by_to_lang_by_word_by_providerArgs, {}>
  };
...
Stability: [stable](https://www.mediawiki.org/wiki/API_versioning#Stable). **/
  ...
  post_media_math_check_by_type: InContextSdkMethod<Mutation['post_media_math_check_by_type'], Mutationpost_media_math_check_by_typeArgs, {}>,
  /** Fetches the machine translation for the posted content from the source
to the destination language.

Stability: [unstable](https://www.mediawiki.org/wiki/API_versioning#Unstable) **/

  post_transform_html_from_by_from_lang_to_by_to_lang: InContextSdkMethod<Mutation['post_transform_html_from_by_from_lang_to_by_to_lang'], Mutationpost_transform_html_from_by_from_lang_to_by_to_langArgs, {}>,
  /** Fetches the machine translation for the posted content from the source
to the destination language.

Stability: [unstable](https://www.mediawiki.org/wiki/API_versioning#Unstable) **/

  post_transform_html_from_by_from_lang_to_by_to_lang_by_provider: InContextSdkMethod<Mutation['post_transform_html_from_by_from_lang_to_by_to_lang_by_provider'], Mutationpost_transform_html_from_by_from_lang_to_by_to_lang_by_providerArgs, {}>
  };
