...
describe.skip('Relay', () => {
  it('should', async () => {
    ...
    expect(postResult.data?.['user0']?.posts[0].content).toBe(
      posts[1]?.content,
    );
    expect(postResult.data?.['user1']?.id).toBe(users[1]?.id);
    expect(postResult.data?.['user1']?.posts[0].content).toBe(
      posts[0]?.content,
    );
    ...
    expect(stitchedResult.data?.['user0']?.posts[0].content).toBe(
      posts[1]?.content,
    );
    expect(stitchedResult.data?.['user1']?.name).toBe(users[1]?.name);
    expect(stitchedResult.data?.['user1']?.posts[0].content).toBe(
      posts[0]?.content,
    );
  });
});
