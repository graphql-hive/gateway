...
> implements Transform<WrapFieldsTransformationContext, TContext> {
  ...
  constructor(
    ...
    this.transformer = new MapFields<TContext>(
        ...
        [outerTypeName]: {
          [outerMostWrappingFieldName]: (
            ...
            hoistFieldNodes({
              ...
              fragments,
              transformationContext:
                transformationContext as WrapFieldsTransformationContext,
              prefix,
            }),
        },
      },
      ...
      (errors, context) =>
        dehoistErrors(errors, context as WrapFieldsTransformationContext),
    );
  }
  ...
  public transformSchema(
    ...
    const newTargetFieldConfigMap: GraphQLFieldConfigMap<any, any> =
      Object.create(null);
