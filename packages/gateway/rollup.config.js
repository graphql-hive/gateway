...
const deps = {
  ...
  'node_modules/@graphql-mesh/serve-runtime/index':
    '../serve-runtime/src/index.ts',
  ...
  'node_modules/@graphql-mesh/plugin-prometheus/index':
    '../plugins/prometheus/src/index.ts',
  'node_modules/@graphql-mesh/plugin-http-cache/index':
    '../plugins/http-cache/src/index.ts',
  'node_modules/@graphql-mesh/plugin-jwt-auth/index':
    '../plugins/jwt-auth/src/index.ts',
...
if (process.env['E2E_SERVE_RUNNER'] === 'docker') {
  ...
  deps['node_modules/@graphql-mesh/compose-cli/index'] =
    '../compose-cli/src/index.ts';
  deps['node_modules/@e2e/opts/index'] = '../../e2e/utils/opts.ts';
  deps['node_modules/@graphql-mesh/utils/index'] =
    '../legacy/utils/src/index.ts';
  deps['node_modules/@omnigraph/openapi/index'] =
    '../loaders/openapi/src/index.ts';
  deps['node_modules/@graphql-mesh/transport-ws/index'] =
  ...
  return {
    ...
    generateBundle(_outputs, bundles) {
      for (const bundle of Object.values(bundles).filter(
        (bundle) =>
          !!deps[String(bundle.name)] &&
          (String(bundle.name).startsWith('node_modules/') ||
            String(bundle.name).startsWith('node_modules\\')),
      )) {
