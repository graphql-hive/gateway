...
const schema = createSchema({
  typeDefs: /* GraphQL */ `
    type Query {
      ...
      forecast("City name" location: String!, "Number of days" days: Int = 5): [ForecastDay!]!
    }
    type Weather { temperature: Float! conditions: String! humidity: Int! location: String! }
    type ForecastDay { date: String! high: Float! low: Float! conditions: String! }
  `,
  resolvers: {
    Query: {
      ...
      forecast: (_: unknown, { days = 5 }: { location: string; days?: number }) => {
