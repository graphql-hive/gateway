...
function nearestIndex<T>(
  ...
  searchStart: NearestSearchStart,
): number | null {
 ...
 * Please note: this presupposes that the array is already ordered.
 */
export function nearestIndexFromBeginning<T>(
  arr: T[],
  predicate: (arrayItem: T) => boolean,
): number | null {
...
export function nearestIndexFromEnd<T>(
  arr: readonly T[],
  predicate: (arrayItem: T) => boolean,
): number | null {
...
export function arrayDoesNotContainNullOrUndefined<T>(
